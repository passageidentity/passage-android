...
import id.passage.android.model.ProtocolAuthenticatorAttestationResponse
...
data class ProtocolCredentialCreationResponse (
    ...
    @Json(name = "response")
    val response: ProtocolAuthenticatorAttestationResponse? = null,
